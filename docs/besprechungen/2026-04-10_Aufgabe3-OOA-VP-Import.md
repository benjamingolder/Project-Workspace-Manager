...
### Aufgabe 3 OOA – Stand
KI-Tool hat das Fachklassenmodell, das Zustandsmodell und das Glossar vollständig erarbeitet und in GitHub unter `docs/analyse/` abgelegt (MD-Dateien, PNG-Exporte). Benjamin hat den Stand via Bildschirmfreigabe gezeigt. Dennis hat die Dokumentation als Grundlage für die VP-Diagramme verwendet.
...
### Diverses
- **KI-Tool Sonnet vs. Opus:** Empfehlung, Sonnet für die meisten Aufgaben zu nutzen (günstiger, schneller, ausreichend). Opus nur für sehr komplexe Tasks.
